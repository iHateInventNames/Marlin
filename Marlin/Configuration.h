...
#define CUSTOM_MACHINE_NAME "SmartCore Aluminium"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,80,165}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 50, 60}    // (mm/sec)
